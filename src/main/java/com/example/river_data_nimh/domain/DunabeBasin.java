...
public class DunabeBasin {
    ...
    @Builder
    public DunabeBasin(Integer a_numSt, String b_name, String c_station, Double d_minQ, Double e_avrQ, Double f_maxQ, Integer g_h, Double h_q, Integer i_dH, LocalDate j_ld){
